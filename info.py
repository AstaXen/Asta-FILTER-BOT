...
# Bot information
SESSION = environ.get('SESSION', 'Mathikunju')
API_ID = int(environ.get('API_ID', '10264891'))
API_HASH = environ.get('API_HASH', '8f71b31ffc2702c0c3b0fef2a157812a')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://www.vecteezy.com/vector-art/2928032-smiling-cute-robot-chat-bot-support-service-concept-vector-cartoon-flat-illustration')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1854078840').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002278268166'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002465614081').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002323586187') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4672483867')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002284248444').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sabithkpoficial:YVNInx9S3Cza6fZy@cluster0.dd4kn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "mathiuniversebot")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+zwTHqCCiv8NhMDE9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Reelgofx')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'sk_bot_disscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/sabith_sk')
